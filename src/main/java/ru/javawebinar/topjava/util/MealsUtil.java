...
public class MealsUtil {
    public static void main(String[] args) {
        ...
        List<MealWithExceed> mealsWithExceeded = getFilteredWithExceeded(mealDao.getAll(), LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
        mealsWithExceeded.forEach(System.out::println);

        System.out.println(getFilteredWithExceededByCycle(mealDao.getAll(), LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
        System.out.println(getFilteredWithExceededInOnePass(mealDao.getAll(), LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
        System.out.println(getFilteredWithExceededInOnePass2(mealDao.getAll(), LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
    }
